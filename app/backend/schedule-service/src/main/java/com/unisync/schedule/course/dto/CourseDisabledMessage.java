package com.unisync.schedule.course.dto;
...
/**
 * 과목 비활성화 이벤트 메시지 (Course-Service → Schedule-Service).
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Schema(description = "과목 비활성화 메시지 (SQS)")
public class CourseDisabledMessage {
