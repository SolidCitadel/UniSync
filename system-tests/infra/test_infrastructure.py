...
class TestSqsQueues:
    ...
    def test_assignment_events_queue_exists(self, sqs_client):
        """lambda-to-courseservice-assignments 큐가 존재하는지 확인"""
    ...
    def test_enrollment_queue_exists(self, sqs_client):
        """lambda-to-courseservice-enrollments 큐가 존재하는지 확인"""
