...
- ✅ Canvas 과제를 자동으로 일정/할일로 변환 (Phase 1 완료)
- ✅ 그룹 프로젝트 일정 공유 및 협업 (Phase 1 완료)
- 🔄 Google Calendar와 양방향 동기화 (Phase 2 계획)
- 🔮 AI 기반 과제 분석 및 자동 서브태스크 생성 (Phase 3 선택)
